    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          <motion.div
            className="relative z-10 w-full max-w-6xl overflow-hidden rounded-[24px] border border-white/40 bg-gradient-to-br from-white/95 to-white/80 shadow-[0_28px_84px_-48px_rgba(15,23,42,0.6)] backdrop-blur-xl"
